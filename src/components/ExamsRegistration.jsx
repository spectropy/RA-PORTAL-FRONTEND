...
const getExamPatternsByProgram = (program) => {
  switch (program) {
    ...
    case 'NGHS_MAE':
        ...
        { id: 'JEE_Level_1', name: 'JEE Level_1', type: 'JEE Level_1' },
        { id: 'JEE_Level_2', name: 'JEE Level_2', type: 'JEE Level_2' },
        { id: 'JEE_Level_3', name: 'JEE Level_3', type: 'JEE Level_3' },
        { id: 'JEE_Level_4', name: 'JEE Level_4', type: 'JEE Level_4' },
        { id: 'JEE_Level_5', name: 'JEE Level_5', type: 'JEE Level_5' },
        { id: 'JEE_Level_6', name: 'JEE Level_6', type: 'JEE Level_6' },
        { id: 'JEE_Level_7', name: 'JEE Level_7', type: 'JEE Level_7' },
        { id: 'JEE_Level_8', name: 'JEE Level_8', type: 'JEE Level_8' },
        { id: 'JEE_Level_9', name: 'JEE Level_9', type: 'JEE Level_9' },
        { id: 'JEE_Level_10', name: 'JEE Level_10', type: 'JEE Level_10' },
        { id: 'JEE_Level_11', name: 'JEE Level_11', type: 'JEE Level_11' },
        { id: 'JEE_Level_12', name: 'JEE Level_12', type: 'JEE Level_12' },
        { id: 'JEE_Level_13', name: 'JEE Level_13', type: 'JEE Level_13' },
        { id: 'JEE_Level_14', name: 'JEE Level_14', type: 'JEE Level_14' },
        { id: 'JEE_Level_15', name: 'JEE Level_15', type: 'JEE Level_15' },
        { id: 'JEE_Level_16', name: 'JEE Level_16', type: 'JEE Level_16' },
        { id: 'JEE_Level_17', name: 'JEE Level_17', type: 'JEE Level_17' },
        { id: 'JEE_Level_18', name: 'JEE Level_18', type: 'JEE Level_18' },

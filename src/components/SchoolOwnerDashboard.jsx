  ...
  const renderExamWiseResultsView = () => {
          ...
          {questionAnalytics.length > 0 && (
            <div
              style={{
                display: "grid",
                gridTemplateColumns:
                  "minmax(520px, 1.05fr) minmax(620px, 1.2fr) minmax(430px, 0.95fr)",
                alignItems: "stretch",
                gap: "18px",
                marginBottom: "20px",
              }}
            ...
            >
              ...
              <div
                style={{
                  display: "grid",
                  gridTemplateColumns: "64px 176px 64px",
                  alignItems: "center",
                  justifyContent: "center",
                  gap: "12px",
                  marginTop: "12px",
                ...
                >
                  {studentCognitiveDistribution.map((band, index) => (
                    <div
                      ...
                      style={{
                        display: "grid",
                        gridTemplateColumns: "220px minmax(250px, 1fr)",
                        alignItems: "center",
                        minHeight: "48px",
                        borderRadius: "8px",
                        background: band.bg,
    ...
    return (
      <div className="exam-results-page">
        ...
        {/* ===== ANALYSIS ACTIONS ABOVE STUDENT TABLE ===== */}
        <div
          style={{
            display: "flex",
            justifyContent: "space-between",
        ...
        <button
          type="button"
          className="exam-results-download-btn exam-results-download-btn--analysis"
          onClick={() => setView("subject-bloom-analytics")}
          style={{
            padding: "9px 16px",
            background: "#2563eb",
            color: "white",
